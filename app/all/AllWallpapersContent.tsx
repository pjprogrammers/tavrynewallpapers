...
import { tags, type Wallpaper } from "../lib/wallpapers";
...
export default function AllWallpapersContent({ initialWallpapers }: Props) {
  const allWallpapers = initialWallpapers;
    ...
    <div className="page-wrapper">
      ...
      <section className="section" aria-label="Wallpaper listing">
        <div className="container">
          ...
          <aside className="browse-more" aria-label="Browse more options">
