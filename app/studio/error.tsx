  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center gap-5 p-10">
      ...
      <p className="text-sm text-zinc-400 max-w-md text-center">
        An unexpected error occurred in the studio. Please try again.
      </p>
      {error.digest && (
      ...
      <button
        onClick={reset}
        className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-lg bg-amber-600 hover:bg-amber-500 text-white text-sm font-medium transition-all"
      >
        <RefreshCw size={16} />
        Try again
      </button>
